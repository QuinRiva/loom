...
import {
  ...
  CommandId,
  EventId,
  GoalId, // loom: retained only for the `aggregateId` union residual below
  IsoDateTime,
  MessageId,
  NonNegativeInt,
  PositiveInt,
...
import {
  ...
  LoomThreadCreatedPayloadFields,
  LoomThreadFields,
...
// loom: one answer per question id — a single chosen/typed value, or the selected
...
export const OrchestrationProject = Schema.Struct({
  ...
  defaultStartFromOrigin: Schema.NullOr(Schema.Boolean),
...
export const ProjectCreateCommand = Schema.Struct({
  ...
  defaultStartFromOrigin: Schema.optional(Schema.NullOr(Schema.Boolean)),
  createdAt: IsoDateTime,
});
...
const ThreadCreateCommand = Schema.Struct({
  ...LoomThreadCreateCommandFields, // loom:
...
const ThreadMetaUpdateCommand = Schema.Struct({
  ...LoomThreadMetaUpdateFields, // loom:
...
const ThreadTurnStartBootstrapCreateThread = Schema.Struct({
  ...LoomBootstrapCreateThreadFields, // loom:
  projectId: ProjectId,
  title: TrimmedNonEmptyString,
  modelSelection: ModelSelection,
  runtimeMode: RuntimeMode,
...
export const ProjectCreatedPayload = Schema.Struct({
  ...
  repositoryIdentity: Schema.optional(Schema.NullOr(RepositoryIdentity)),
  defaultModelSelection: Schema.NullOr(ModelSelection),
  defaultStartFromOrigin: Schema.NullOr(Schema.Boolean).pipe(
    Schema.withDecodingDefault(Effect.succeed(null)),
  ),
...
export const ThreadCreatedPayload = Schema.Struct({
  ...LoomThreadCreatedPayloadFields, // loom:
  threadId: ThreadId,
  projectId: ProjectId,
  title: TrimmedNonEmptyString,
  modelSelection: ModelSelection,
...
export const ThreadMetaUpdatedPayload = Schema.Struct({
  ...LoomThreadMetaUpdatedPayloadFields, // loom:
  threadId: ThreadId,
...
const EventBaseFields = {
  ...
  aggregateId: Schema.Union([ProjectId, GoalId, ThreadId]), // loom: GoalId member
