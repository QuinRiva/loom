...
gh pr merge --merge --delete-branch                # merge and clean up the remote branch
```
...
- `--delete-branch` removes the remote branch after merge. Delete the local
  branch/worktree separately if you no longer need it.
