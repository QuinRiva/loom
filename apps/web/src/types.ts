...
// loom: DB-authoritative goals arrive on the orchestration shell snapshot. The
// web aliases mirror the thread aliases above so feature code stays decoupled
// from the contract module names.
