import { CommandId, GoalId, GoalTaskId, MessageId, ProjectId, ThreadId } from "@t3tools/contracts";
...
export const newGoalTaskId = (): GoalTaskId => GoalTaskId.make(randomUUID());
