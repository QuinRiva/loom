...
export const MessagesTimeline = memo(function MessagesTimeline({
  ...
  useScrollToDispatch(rows, listRef, routeThreadKey);
  ...
  // loom: measurement stays in the shared useTimelineAvailableWidthVar hook
  // (which also drives the timeline available-width CSS var); upstream's minimap
  // hit-strip-width measurement is folded into the same callback.
  ...
  // Two nested pagination affordances, finest first: loom's older-activity
  // paging inside the loaded turn window, then upstream's earlier-turn window
  // paging (#5493) once that window has nothing older left to fetch.
  ...
  }, [loadingOlder, hasMoreOlder, onLoadOlder, loadEarlier, topFadeEnabled]);
