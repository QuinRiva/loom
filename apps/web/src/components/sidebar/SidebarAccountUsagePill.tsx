...
const PILL_TONE_STYLES: Record<AccountUsageTone, string> = {
  quiet: "bg-muted/50 text-muted-foreground hover:bg-muted",
      ...
      <PopoverTrigger
        ...
        render={
          <button
            ...
            className={cn(
              "flex h-7 w-full items-center gap-2 rounded-lg px-2 text-xs font-medium outline-none transition-colors",
