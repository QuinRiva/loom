    ...
    <View className="-mx-1 mb-1 px-1 py-0">
      ...
      <View className="gap-px">
        {rows.map((row) => {
          ...
          // loom's ThreadFeedActivity carries the expanded body eagerly;
          // upstream's lazy getters are deferred with the rest of that file.
          const canExpand = row.fullDetail !== null;
          const fullDetail = expanded ? row.fullDetail : null;
