      ...
      Effect.scoped(
        Effect.gen(function* () {
          ...
          yield* Effect.gen(function* () {
            ...
            // The DISPATCHER's generation wake. Startup reconciliation no longer
            // emits a turn-start of its own (upstream's #9167 owns restart
            // continuation), so this is the only turn-start on the parent.
