...
// loom: a command the decider parked rather than rejected.
export class OrchestrationCommandDeferredError extends Schema.TaggedError<OrchestrationCommandDeferredError>()(
...
export type OrchestrationDispatchError =
  ...
  | OrchestrationCommandIdConflictError
  | OrchestrationCommandPreviouslyRejectedError
  | OrchestrationCommandDeferredError // loom:
  | OrchestrationProjectorDecodeError;
