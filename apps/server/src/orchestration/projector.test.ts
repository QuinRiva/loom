...
describe("orchestration projector", () => {
  it("applies thread.created events", async () => {
    ...
    // Asserted with toMatchObject, not toEqual: this test owns "thread.created
    // seeds the projected thread from its payload and defaults the rest", not
    // "OrchestrationThread has exactly these fields" — a whole-object compare
    // breaks on every additive schema field regardless of this behaviour.
