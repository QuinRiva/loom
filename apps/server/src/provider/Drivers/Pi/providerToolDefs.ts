    ...
    parameters: {
      ...
      properties: {
        ...
        title: {
          type: "string",
          description:
            "Short imperative label naming the work at a glance — the card's bold name, roughly ≤6 words (e.g. 'Fix spawn title fallback'). Distinct from purpose, which is the one-sentence why. Required.",
        },
        blockedBy: {
          type: "array",
          items: { type: "string" },
