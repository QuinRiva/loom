    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.defaultStartFromOrigin !== null ? JSON.stringify(row.defaultStartFromOrigin) : null},
        ...
        DO UPDATE SET
          ...
          default_start_from_origin = excluded.default_start_from_origin,
